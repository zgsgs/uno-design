  ...
  <div id="content">
    ...
    <div id="footer">
      <div class="footer-item">
        <ul v-for="(listItem, index) in bottomList" :key="index" class="list">
          <h4 class="title">
            {{ listItem.title }}
          </h4>
